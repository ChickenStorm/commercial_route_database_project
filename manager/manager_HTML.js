...
function drawInterfaceInit(){
    ...
    $("liste1Container").innerHTML = "<input id=input1> <button onclick='searchListe1()'> cherch&eacute;</button> : <select style=';' id='field1'> <option value='playerName'>nom du joueur</option> <option value='name'>nom</option> </select>   <input type=checkBox id=checkBox1> Regular expression <div id=list1></div>"
    
    $("liste2Container").style.left ="700px"
    $("liste2Container").style.top = "350px"
    //$("liste2Container").style.width = "10px"
    $("liste2Container").innerHTML = "<input id=input2>  <button onclick='searchListe2()'> cherch&eacute;</button> : <select style=';' id='field2'> <option value='playerName'>nom du joueur</option> <option value='name'>nom</option> </select>  <input type=checkBox id=checkBox2> Regular expression <div id=list2></div>"
...
function darwCommRouteTable(container,array){
    ...
    container.innerHTML = "<button onclick='computeCommRoutes()'> calcul&eacute; </button>"+getHTMLTable(arrayToDraw,styleArrayToDraw)
}